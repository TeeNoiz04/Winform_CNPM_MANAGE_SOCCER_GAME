    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatchOfficials", x => new { x.IdGame, x.IdReferee });
                    table.ForeignKey(
                        name: "FK_MatchOfficials_Games_IdGame",
                        column: x => x.IdGame,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MatchOfficials_Referees_IdReferee",
                        column: x => x.IdReferee,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdTournament = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatchdaySquads", x => new { x.IdGame, x.IdPlayer });
                    table.ForeignKey(
                        name: "FK_MatchdaySquads_Games_IdGame",
                        column: x => x.IdGame,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MatchdaySquads_Players_IdPlayer",
                        column: x => x.IdPlayer,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PenaltyCards_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Time = table.Column<TimeSpan>(type: "time", nullable: false),
                    SoccerType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GoalScorerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NumberAssitant = table.Column<int>(type: "int", nullable: false),
                    GameId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SoccerGames_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatchdaySquads_IdPlayer",
                table: "MatchdaySquads",
                column: "IdPlayer");

            migrationBuilder.CreateIndex(
                name: "IX_MatchOfficials_IdReferee",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SoccerGames_GameId",
                table: "SoccerGames",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_SoccerGames_GoalScorerId",
                table: "SoccerGames",
                column: "GoalScorerId");
